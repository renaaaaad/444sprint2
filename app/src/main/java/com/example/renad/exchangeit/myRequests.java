...
return view ;
    ...
    public void myRequests(final String id ){
        ...
        reference3.child("requests").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                reference4.child(id).child("Initiate_requests").addListenerForSingleValueEvent(new ValueEventListener(){
...
final TextView phonenumber = new TextView(getContext());
                         ...
                         final   String recive =   user_requests2.getRecive_user() ;
                            String productRecive = user_requests2.getRecive_product();
                            final String me = user_requests2.getInitial_user();
                            String my_product = user_requests2.getInitial_product() ;
