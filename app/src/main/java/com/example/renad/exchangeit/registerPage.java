...
// grnrate
                    ...
                    user=new User(id,firstName.getText().toString(),lastName.getText().toString(),phone.getText().toString(), city, Email.getText().toString(),"https://firebasestorage.googleapis.com/v0/b/exchangeit-3940a.appspot.com/o/images%2FUsers%2Fprofile%2Fprofile.png?alt=media&token=ae8792ac-afe9-409b-8eaa-bd69c23ccb08" , "User" , 0,0,0);
                    user_data.child(uid).setValue(user);
                    user_data.child(uid).child("number").setValue("0");
